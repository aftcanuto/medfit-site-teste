      ...
      <div className="wrap">
        ...
        <Link
          ...
          className="reveal group flex items-center justify-between gap-4
                     rounded-3xl p-6 lg:p-9 mb-4 bg-white
                     transition-all duration-300 hover:-translate-y-0.5 hover:shadow-float"
          style={{ border: "2px solid #1D9E75" }}
        >
          <div>
            <span className="inline-block text-verde-dark text-[11px] font-medium tracking-widest uppercase
                             bg-verde-light rounded-full px-3 py-1">
              {UI.services.featuredBadge}
            </span>
            <h3 className="font-display text-ink text-xl lg:text-3xl font-medium mt-2.5 mb-2
                           group-hover:text-verde transition-colors duration-200">
              {featured.title}
            </h3>
            <p className="text-ink-muted text-[13px] leading-relaxed max-w-md">{featured.description}</p>
          </div>
          <div className="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center bg-verde
                          transition-all duration-300 group-hover:bg-verde-dark">
            <ArrowRight size={16} className="text-white transition-transform duration-200 group-hover:translate-x-0.5" />
          </div>
        </Link>
