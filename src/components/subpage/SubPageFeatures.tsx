import {
  Scale, PersonStanding, Gauge, HeartPulse, ScanLine,
  Stethoscope, Ruler, Thermometer, type LucideIcon,
} from "lucide-react";

// Ícones disponíveis para os cards (usados quando não há foto)
// Para usar: adicione `icon: "scale"` (etc.) no item em content-*.ts
                ...
                f.foto ? (
                  ...
                  <div className={`h-32 flex items-center justify-center
                    ...
                    <div className={`w-14 h-14 rounded-2xl flex items-center justify-center
                      ...
                      {(() => { const Icon = ICONS[f.icon!]; return (
                        <Icon size={26} strokeWidth={1.6}
                              className={dark ? "text-verde-mid" : "text-verde-dark"} />
                      ); })()}
                    </div>
                  </div>
                ) : (
