...
export const CONTATO = {
  hero: {
    ...
    body:     "Nossa equipe irá compreender sua necessidade e orientar se o atendimento mais indicado é médico, físico, integrado ou uma avaliação específica.",
  },
  ...
  card: {
    ...
    endereco: {
      label:      "Endereço",
      logradouro: "Av. Abrahão Caram, 620",  // ← editar
    ...
    horarios: {
      ...
      items: [
        { dias: "Segunda a Sexta", hora: "Mediante agendamento a partir das 17h" }, // ← editar
        { dias: "Sábado e Domingo", hora: "Mediante agendamento de 08h às 12h" },
      ],
    },
  },
