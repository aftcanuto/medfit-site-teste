...
export const VO2 = {
  ...
  features: {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Importância: Conhecer o segundo limiar ajuda a organizar intensidades de treino e controlar a distribuição da carga, evitando que sessões intensas sejam realizadas de forma excessiva ou sem planejamento.",
      },
      {
  ...
  process: {
    ...
    title:   "Protocolo do teste de VO₂máx.",
    steps: [
      {
        number:      "01",
        title:       "Preparação",
        description: "Refeição leve e intervalo adequado, roupas confortáveis. Sem treino intenso nas 24h anteriores.",
      },
      {
        number:      "02",
  ...
  cta: {
    title:  "Descubra suas zonas e treine de forma mais inteligente.",
