...
export const LOJA = {
  hero: {
    eyebrow:     "Serviços MedFit",
    title:       "Serviços e pacotes.",
    titleAccent: "Invista na sua saúde.",
    description: "Consultas avulsas, testes isolados ou pacotes fechados — escolha o que faz sentido para o seu objetivo. Tudo com atendimento individualizado e acompanhamento real da equipe MedFit.",
  },
