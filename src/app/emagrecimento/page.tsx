          ...
          <div className="wrap">
            ...
            <div className="bg-white rounded-4xl border border-ink-border shadow-card p-7 lg:p-10">
              <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
                ...
                {/* Eyebrow + título + texto + lista à direita */}
                <div>
                  <p className="text-verde text-[11px] font-medium tracking-[0.16em] uppercase mb-4">
                    {d.beneficios.eyebrow}
                  </p>
                  <h2
                    className="font-display text-display-sm leading-[1.1] mb-4"
                    style={{ color: "#0E2A1E" }}
                  >
                    {d.beneficios.title}
                  </h2>
                  <p className="text-ink-muted text-[14px] leading-relaxed mb-7">
                    {d.beneficios.body}
                  </p>
                  <p className="text-[13px] font-semibold mb-4" style={{ color: "#0E2A1E" }}>
                    {d.beneficios.listaTitulo}
                  </p>
